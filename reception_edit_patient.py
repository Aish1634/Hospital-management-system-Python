...
def save():
    ...
    insert = ("UPDATE patient SET P_Name = '{}',DOB = '{}',Age = {},Gender = '{}',Blood_group = '{}',Height = '{}',Weight = '{}',Mail_ID = '{}',Phone_number = '{}' WHERE P_ID='{}'").format(en2,en3,en4,en5,en6,en7,en8,en9,en10,en1)
    cursor.execute(insert)
    mycon.commit()
    
    Label(tk,text="PATIENT UPDATED SUCCESSFULLY..!",font=("Archivo Expanded",15),bg="#F6F6F6",fg="green").place(x=510,y=750)
...
m=Button(tk,text="UPDATE",font=("Archivo Expanded",13),bg="#1A374D",fg="#F5F5F5",command=save).place(x=650,y=700)
