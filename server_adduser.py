...
def save():
    ...
    if(c==1):
        ...
        Label(tk,text="USER-ID:",font=("Archivo Expanded",15),bg="#F6F6F6",fg="#1A374D").place(x=580,y=550)
        Label(tk,text=uid,font=("Archivo Expanded",15),bg="#F6F6F6",fg="#1A374D").place(x=750,y=550)
        Label(tk,text="PASSWORD:",font=("Archivo Expanded",15),bg="#F6F6F6",fg="#1A374D").place(x=580,y=620)
        Label(tk,text=password,font=("Archivo Expanded",15),bg="#F6F6F6",fg="#1A374D").place(x=750,y=620)
        Label(tk,text="USER ADDED SUCCESSFULLY..!",font=("Archivo Expanded",15),bg="#F6F6F6",fg="green").place(x=520,y=700)
